...
public struct LBRTransaction: CustomStringConvertible {
    ...
    public func mergedWithOptions(_ options: Chain3Options) -> LBRTransaction {
        var tx = self
...
"""
    ...
    /**
     Initializes LBRTransaction from RLP encoded data
     - parameter raw: RLP encoded data
     - returns: LBRTransaction if data wasn't not corrupted
     */
    public static func fromRaw(_ raw: Data) -> LBRTransaction? {
        ...
        case 9?:
            ...
            let s = BigUInt(sData)
            return LBRTransaction(nonce: nonce, gasPrice: gasPrice, gasLimit: gasLimit, to: to, value: value, data: transactionData, v: v, r: r, s: s)
        case 6?:
            return nil
        default:
            return nil
    ...
    static func createRequest(method: JsonRpcMethod, transaction: LBRTransaction, onBlock: String? = nil, options: Chain3Options?) -> JsonRpcRequest? {
...
//        guard let from = options?.from else { return nil }
    ...
    static func createRawTransaction(transaction: LBRTransaction) -> JsonRpcRequest? {
